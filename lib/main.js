...
// Intentionally removing the lodash requirement so that this module doesn't pull it in as a dependency.
// This is so that it can be used in a browserify bundle in a front-end environment in which lodash is 
// being loaded separately, so we want to avoid bloating the bundle with a duplicate copy of lodash.
